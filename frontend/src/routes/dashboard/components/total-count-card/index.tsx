...
import { AreaConfig } from "@ant-design/plots/es/interface";
...
export const DashbaordTotalCountCard: React.FC<{
  resource: Type;
  isLoading: boolean;
  totalCount?: number;
...
const IconWrapper: React.FC<PropsWithChildren<{ color: string }>> = ({
  color,
  children,
}) => {
  return (
